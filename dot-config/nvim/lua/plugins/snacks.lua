return {
	...
	keys = {
		...
		-- { "<leader>gm", function() require("snacks").git.blame_line() end, desc = "Git blame", },
		...
		{ "<leader>N", desc = "Neovim News", function() require("snacks").win({ file = vim.api.nvim_get_runtime_file("doc/news.txt", false)[1], width = 0.6, height = 0.6, wo = { spell = false, wrap = false, signcolumn = "yes", statuscolumn = " ", conceallevel = 3, }, }) end, },
	},
	init = function()
